  ...
  const renderAdSlot = () => (
    <div className="my-8">
      <div className="rounded-2xl border border-white/10 bg-white/5 p-5 md:p-6 shadow-lg shadow-black/30 overflow-hidden">
        ...
        <div className="relative rounded-xl border border-white/10 bg-black/40 h-32 flex items-center justify-center text-gray-400 text-xs">
        ...
        <div className="px-6 md:px-10 pb-10 pt-8 max-w-[2000px] mx-auto">
          {activeSection === "search" ? (
            ...
            <>
              ...
              {!isAuthenticated && activeSection === "home" && renderAdSlot()}
