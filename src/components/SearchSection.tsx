  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <select
        ...
        className="bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-1 focus:ring-white/30 cursor-pointer"
      >
        {options.map((opt) => (
  ...
  if (showEmpty) {
    return (
      <div className="text-center py-20">
        ...
        <p className="text-gray-500 mt-2 text-sm">Or use filters to browse</p>
      </div>
    );
  }
    ...
    <div>
      ...
      {showFilters && (
        <div className="mb-6 p-5 bg-white/5 border border-white/10 rounded-xl">
          ...
          {/* Genre Pills */}
          <div className="mb-4">
            <label className="text-xs text-gray-400 uppercase tracking-wider block mb-2">Genre</label>
      ...
      {!isLoading && results.length === 0 && (
        <div className="text-center py-20">
          ...
          {query && <p className="text-gray-500 mt-2">Try a different search term or adjust filters</p>}
        </div>
      )}
